export default function TrainingAndProficiencies() {
  return (
    <div className="overflow-x-auto max-h-[500px]">
      <h2 className="text-3xl text-secondary text-outline-secondary-content font-bold font-fantasy mb-5 text-center underline">
        ...
        <table className="table  bg-primary/60 gap-2 table-xs table-pin-rows table-pin-cols">
          <thead>
            <tr className="bg-primary">
              <td className="text-center text-primary-content font-fantasy font-extrabold text-2xl underline ">
                Type
              </td>
              <td className="text-center text-primary-content font-fantasy font-extrabold text-2xl underline">
                Content
          ...
          <tbody>
            <tr>
              <td className="pt-5 w-[25%]">
                <p className="text-xl underline text-outline-secondary font-fantasy font-extrabold w-full text-center">
                  Weapons
                </p>
              </td>
